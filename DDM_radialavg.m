function [Zr, R] = DDM_radialavg(z,m)
% RADIALAVG	 Radially averaqe 2D square matrix Z into M bins
%
% David Fischer (2021). radialavg.zip (https://www.mathworks.com/matlabcentral/fileexchange/46468-radialavg-zip), MATLAB Central File Exchange. Retrieved October 7, 2018.
%
% [Zr, R] = radialavg(z,m)
%
